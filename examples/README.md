...
policy matrices, reports, history timelines, comparisons, action plans, ticket
drafts, and bundle manifests. Reports can also be rendered as JUnit XML for CI
systems. Generated files are ignored by git so they can be reviewed without
polluting commits.
