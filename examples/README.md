...
- `cyclonedx.sample.json` contains a trimmed CycloneDX SBOM JSON output.
...
evidence scaffolds, evidence quality reports, scope reports, service catalog reports, exposure reports, firewall reports, patch reports, vulnerability reports, software inventory reports, runtime reports, service-level reports, runbook coverage
