...
python -m openops_evidence review create -i evidence.local.json -p examples/policy.baseline.toml --scope examples/scope.sample.toml -o review-pack --archive review-pack.zip --min-score 90 --max-warnings 0
```
