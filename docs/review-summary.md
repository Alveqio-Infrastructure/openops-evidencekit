...
network exposure, firewall report, patch report, vulnerability report, software inventory report, runtime report, service-level report, runbook, restore assurance, mail-domain, TLS certificate,
access exposure, monitoring, and incident readiness signals into one handoff
decision.
...
`monitoring-report.md`, `exposure-report.md`, `firewall-report.md`, `patch-report.md`, `vulnerability-report.md`, `software-inventory-report.md`, `runtime-report.md`, `service-level-report.md`, `incident-report.md`, or
service/runbook reports.
