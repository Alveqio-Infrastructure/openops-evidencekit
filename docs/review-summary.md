...
runbook, restore assurance, mail-domain, TLS certificate, and access exposure signals into one
handoff decision.
...
`mail-report.md`, `tls-report.md`, `access-report.md`, or service/runbook
reports.
