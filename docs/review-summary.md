...
runbook, restore assurance, mail-domain, TLS certificate, access exposure,
monitoring, and incident readiness signals into one handoff decision.
...
`monitoring-report.md`, `incident-report.md`, or service/runbook reports.
