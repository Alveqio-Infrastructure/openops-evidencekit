...
coverage, runbook coverage, evidence freshness, restore assurance, Markdown,
mail domain reports, JUnit, SARIF, badge, executive brief, risk register, scorecard, history
