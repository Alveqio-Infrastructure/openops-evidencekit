...
python -m openops_evidence freshness report -i examples/evidence.sample.json --max-age-days 30 -f json -o freshness-report.json
python -m openops_evidence validate -i freshness-report.json -t freshness-report
python -m openops_evidence freshness report -i examples/evidence.sample.json --max-age-days 30 -o freshness-report.md
python -m openops_evidence restore report -i examples/evidence.sample.json --max-drill-age-days 90 -f json -o restore-report.json
python -m openops_evidence validate -i restore-report.json -t restore-report
python -m openops_evidence restore report -i examples/evidence.sample.json --max-drill-age-days 90 -o restore-report.md
python -m openops_evidence mail report -i examples/evidence.sample.json -f json -o mail-report.json
python -m openops_evidence validate -i mail-report.json -t mail-report
python -m openops_evidence mail report -i examples/evidence.sample.json -o mail-report.md
python -m openops_evidence tls report -i examples/evidence.sample.json -f json -o tls-report.json
python -m openops_evidence validate -i tls-report.json -t tls-report
python -m openops_evidence tls report -i examples/evidence.sample.json -o tls-report.md
python -m openops_evidence access report -i examples/evidence.sample.json -f json -o access-report.json
python -m openops_evidence validate -i access-report.json -t access-report
python -m openops_evidence access report -i examples/evidence.sample.json -o access-report.md
...
python -m openops_evidence firewall report -i examples/evidence.sample.json -f json -o firewall-report.json
python -m openops_evidence validate -i firewall-report.json -t firewall-report
python -m openops_evidence firewall report -i examples/evidence.sample.json -o firewall-report.md
python -m openops_evidence patch report -i examples/evidence.sample.json -f json -o patch-report.json
python -m openops_evidence validate -i patch-report.json -t patch-report
python -m openops_evidence patch report -i examples/evidence.sample.json -o patch-report.md
...
python -m openops_evidence service-level report -i examples/evidence.sample.json -c examples/service-catalog.sample.toml -f json -o service-level-report.json
python -m openops_evidence validate -i service-level-report.json -t service-level-report
python -m openops_evidence service-level report -i examples/evidence.sample.json -c examples/service-catalog.sample.toml -o service-level-report.md
python -m openops_evidence incident report -i examples/evidence.sample.json -c examples/service-catalog.sample.toml -f json -o incident-report.json
python -m openops_evidence validate -i incident-report.json -t incident-report
python -m openops_evidence incident report -i examples/evidence.sample.json -c examples/service-catalog.sample.toml -o incident-report.md
...
3. Confirm `schemas/evidence.schema.json`, `schemas/report.schema.json`,
   ...
   `schemas/restore-report.schema.json`,
   `schemas/mail-report.schema.json`,
   ...
   `schemas/firewall-report.schema.json`,
   `schemas/patch-report.schema.json`,
   ...
   `schemas/completeness-report.schema.json`,
