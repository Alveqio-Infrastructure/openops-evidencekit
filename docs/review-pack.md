...
| `exposure-report.json` / `exposure-report.md` / `exposure-report.csv` | Optional open port and risky public service report when exposure evidence or policy paths exist. |
