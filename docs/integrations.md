...
| Review pack | `openops-evidence review create -i evidence.json -p policy.toml -o review-pack --archive review-pack.zip` | Generate a complete handoff folder and ZIP archive with browser index, report, brief, inventory, gate, badge, action plan, privacy scan, and manifest. |
